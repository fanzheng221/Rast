...
最快速体验 Rast 的方式是将其安装为全局命令行工具。你可以使用 npm、yarn 或 pnpm 安装 `@rust_ast/cli` 包：
...
*(如果你不想全局安装，也可以在下文命令中直接使用 `npx @rust_ast/cli` 替代 `rast`)*
...
### Node.js 绑定 API (`@rust_ast/bindings`)
